...
const projects = [
  ...
  },
  {
    ...
    desc: 'RAG chatbot for intelligent incident query resolution using internal documents. Powered by LangChain, Pinecone vector store, and Groq (Llama-3.3).',
    stats: ['RAG Architecture', 'Incident Resolution'],
    tech: ['React', 'Python', 'FastAPI', 'LangChain', 'Pinecone', 'Groq', 'HuggingFace'],
