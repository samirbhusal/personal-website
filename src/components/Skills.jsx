...
const categories = [
  {
    ...
    icon: '🧪',
    skills: [
      { name: 'Playwright',         icon: '🎭', level: 'Expert',        desc: 'Multi-environment Playwright-BDD framework at Bio-Techne' },
      { name: 'Playwright-BDD',     icon: '🥒', level: 'Expert',        desc: 'TypeScript BDD framework with Gherkin and POM design' },
  ...
  },
  {
    ...
    icon: '🔧',
    skills: [
      { name: 'Azure DevOps',    icon: '☁️', level: 'Advanced',      desc: 'Pipelines & Test Plans — CI/CD for smoke/PR and nightly regression' },
      { name: 'GitHub Actions',  icon: '⚙️', level: 'Advanced',      desc: 'CI/CD workflow automation and integration' },
      ...
      { name: 'Allure Reports',  icon: '📊', level: 'Advanced',      desc: 'Stakeholder-facing test execution dashboards' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Cross-Browser',     icon: '🌍', level: 'Expert',        desc: 'Cross-browser & cross-platform testing with BrowserStack' },
      { name: 'Agile / Scrum',      icon: '🏃', level: 'Advanced',      desc: 'Active participant in sprint ceremonies & retrospectives' },
      { name: 'CI/CD',              icon: '🔄', level: 'Advanced',      desc: 'Azure DevOps & GitHub Actions pipeline integration' },
    ],
  },
]
